...
function App() {
    ...
    const handleRun = () => {
        setIsPortfolioVisible(true); // Montre le portfolio ou les informations supplémentaires
    };

    return (
        <>
            <Terminal onRun={handleRun} />
            {isPortfolioVisible && (
                <>
                    <Landing />
                    {/* Project 1 */}
                    ...
                    >
                        <div className="flex flex-col justify-end gap-6 z-10">
                            <h2 className="font-title text-4xl text-center md:text-left md:text-6xl">Bioseine</h2>
                            <ul className="flex items-center justify-start text-sm md:text-md font-semibold gap-3">
                            ...
                            <p className="font-semibold pr-20 text-md hidden md:block md:text-lg w-full md:w-[80%]">
                    ...
                    >
                        <div className="flex flex-col justify-end gap-6 text-white z-10">
                            ...
                            <ul className="flex items-center justify-start txt-sm md:text-md font-semibold gap-3">
