...
const PortfolioProject: React.FC<PortfolioProjectProps> = ({
    ...
    return (
        <div className={`group col-span-2 row-span-2 h-full ${project.color} rounded-xl overflow-hidden shadow-white-xl relative cursor-pointer text-white`}>
            ...
            <div className="absolute top-[-100%] group-hover:top-0 bg-zinc-900 bg-opacity-40 flex flex-col gap-3 justify-end w-full h-full p-4 transition-all duration-500 ease-in-out">
